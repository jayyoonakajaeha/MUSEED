        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm">
              ...
              {activity.action_type === "created a new playlist" && t.feed.created}
              {activity.action_type === "liked" && t.feed.liked}
              {activity.action_type === "started following" && t.feed.followed}
              {" "}
